...
const Navbar = () => {
  ...
  // 1. Ref to track the nav element
  ...
  // 2. Handle click outside to close mobile menu
  useEffect(() => {
  ...
  return (
    ...
    >
      {/* 3. Attach ref={navRef} here */}
      <nav
        ref={navRef}
        className="max-w-6xl mx-auto mt-4 px-4 sm:px-6 md:px-8 py-2.5 sm:py-3 md:py-4 flex items-center justify-between bg-white/10 backdrop-blur-md border border-white/20 rounded-full shadow-lg relative"
      >
